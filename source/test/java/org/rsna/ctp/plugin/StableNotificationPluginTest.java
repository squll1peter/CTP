...
/**
 * Tests for StableNotificationPlugin: constructor attribute parsing,
 ...
 */
public class StableNotificationPluginTest {
    ...
    public void defaults_areApplied_whenOptionalAttributesMissing() throws Exception {
        StableNotificationPlugin p = new StableNotificationPlugin(
    ...
    @Test
    public void staticArguments_parsedFromOtherArguments() throws Exception {
        // Verify the plugin constructs without exception when multiple static pairs given.
        StableNotificationPlugin p = new StableNotificationPlugin(
                buildElement("baseUrl",        "http://localhost/api",
                             "otherArguments", "key1=val1;key2=val2",
                             "enable",         "no"));
    ...
    public void dynamicArguments_parsedFromArguments() throws Exception {
        // Verify construction succeeds with dynamic argument pairs (key:dicomtag).
        StableNotificationPlugin p = new StableNotificationPlugin(
                buildElement("baseUrl",   "http://localhost/api",
                             "arguments", "pid:00100020;suid:0020000D",
                             "enable",    "no"));
        assertTrue(p.notify(null));
    }
    ...
    public void notify_GET_encodesStaticParamsInQueryString() throws Exception {
        ...
        try {
            StableNotificationPlugin p = new StableNotificationPlugin(
                    buildElement("baseUrl",        "http://localhost:" + port + "/api",
                                 "method",         "GET",
                                 "otherArguments", "source=CTP;env=test",
                                 "retry",          "1"));
            p.notify(null);
